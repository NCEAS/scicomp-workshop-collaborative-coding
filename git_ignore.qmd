...
Say that you commit something and later decide you actually don't want that file to be tracked by `git` any more. In this case, you'll need to do the following:

1. Delete the file (or move it out of the repository's folder)

2. **Commit** the deletion

3. **<span style="color:green">Push</span>** that change

Once you've done these three steps your file won't be tracked by `git` even if you add it back to your repository.
